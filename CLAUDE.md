...
Good job on the Music.html, I'd like the headline to be performance-first instead of music director. Most of my music career has been under the direction of great music directors, and I would not necessarily claim to group myself in with them. I've directed brass quintets, a-capella, and small choir groups, and would not claim to be a professional music director even though I have some of those competencies. The music.html can make mention of my music director and assistant music director positions in various groups, but not in the headline. Also let's add images scattered throughout the music page in a tasteful layout and give the entire page an authentic soft warm sort of "stage lighting" like we're inside Kleinhans (buffalo philharmonic orchestra stage) with images of french horn, closeup professional photographs, stages I've performed on, groups I've performed an sang with, etc. Images I have not yet added to assets please indicate on the website where the image is placed where to insert the file and what name to give it while keeping everything professional web dev. I do not hold a current position in some of the groups mentioned, so let's keep it to performing ensembles I have played in instead of putting a direct claim to membership of each. For example I graduated so I don't sing with UB Choir anymore and I haven't played with ASO in recent years. I do currently hold membership of the american legion band and other ensembles. 
Please also include the teachers I've studied privately under. I studied under Tim Schwartz in high school, Jacek Muzyk in College, and Roland Martin for Organ performance in college. (Check name spelling).
Keep polishing up the page. Reserve a spot for additional directors I've performed under including Claudia Brown at UB, Jaman Dunn at UB and Erie County Orchestra (confirm year), Michael Shaw with American legion Band, and an ASO director that I need to find the name of among others. For all people mentioned let's include a link to their facebook, and other places for them to refer to the director's acolades.
